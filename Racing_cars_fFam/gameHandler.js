...
gameOver.src = "assets/audio/mixkit-game-over-trombone-1940.WAV";
...
function onGameOver() {
    ...
    startScreen.innerHTML = `
        ...
        Press here to restart the game.<br>
        <button id="home-button" style="text-align: center; padding-top: 10px; padding-left: 40px;" class="returnhome2" onclick="goHome()">Return Home</button>
    `;
 
    // document.querySelector('.home-button').style.display = 'block';
    const returnButton = document.getElementById("home-button");
